...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CovidData>(builder: (context, covidData, child) {
      if (covidData.indiaList.length != 0) {
        CovidModel indiaElement = covidData.indiaList[0];
        return Scaffold(
          backgroundColor: bg,
                    ...
                    Row(
                      ...
                      children: [
                        ContainerNeuSquare(
                          ...
                          status: 'Confirmed',
                          newNumber: '+' + indiaElement.newConfirmed,
                          totalNumber: indiaElement.confirmed,
                          x: -10.0,
                          y: -10.0,
                        ...
                        ContainerNeuSquare(
                          ...
                          status: 'Active',
                          newNumber: '',
                          totalNumber: indiaElement.active,
                          widthOfDevice: widthOfDevice,
                        )
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ContainerNeuSquare(
                          ...
                          status: 'Recovered',
                          newNumber: '+' + indiaElement.newRecovered,
                          totalNumber: indiaElement.recovered,
                          widthOfDevice: widthOfDevice,
                        ),
                        SizedBox(
                          width: 20,
                        ...
                        ContainerNeuSquare(
                          ...
                          status: 'Deceased',
                          newNumber: '+' + indiaElement.newDeaths,
                          totalNumber: indiaElement.deaths,
                          widthOfDevice: widthOfDevice,
                        ),
                      ],
                    )
                  ...
                  FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => UserListScreen(covidData)));
                    },
                    child: Icon(
